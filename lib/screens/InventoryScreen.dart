...
class _InventoryScreenState extends State<InventoryScreen> with WidgetsBindingObserver, AutomaticKeepAliveClientMixin {
              ...
              if (nameController.text.isNotEmpty &&
                ...
                try {
                  ...
                  final Map<String, dynamic> payload = {
                    ...
                    "category": int.tryParse(categoryController.text) ?? 1,
                  ...
                  if (resp.statusCode == 200 || resp.statusCode == 201) {
                    ...
                    String errorText = isEdit ? "Failed to update product" : "Failed to add product";
                    try {
              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Text(isEdit ? "Edit Product" : "Add Product", style: const TextStyle(color: Colors.black, fontSize: 18)),
                      const SizedBox(height: 16),
                      _buildTextField(nameController, "Product Name"),
                      const SizedBox(height: 16),
                      _buildTextField(descriptionController, "Description"),
                      const SizedBox(height: 16),
                      _buildTextField(categoryController, "Category", keyboardType: TextInputType.number),
                      const SizedBox(height: 16),
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(
                            onPressed: (isEdit ? _isEditingProduct : _isAddingProduct)
                                ? null
                                : () {
                              Navigator.of(context).pop();
                            },
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(
            "$label: ",
            style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.black, fontSize: 10),
          ),
          Text(
